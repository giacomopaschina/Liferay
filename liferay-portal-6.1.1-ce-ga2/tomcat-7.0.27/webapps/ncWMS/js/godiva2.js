...
function addNodes(parentNode, layerArray)
{
    ...
    var id_string=document.URL;
    var id_final=id_string.substring(id_string.indexOf('?')+1,id_string.length);
//    this.alert("layer arr: "+layerArray.length);
    ...
    for (var i = 0; i < layerArray.length; i++) {
       ...
       // this.alert(layer.id);
//        this.alert("final: "+id_final);
//        if(layer.id !==undefined)
//            this.alert(layer.id.split("/")[0]);
//        else
//            this.alert("e' indefinito");
        if((typeof layer.id === 'undefined' && layer.children[0].id.split("/")[0]=== id_final) || (layer.id !==undefined && layer.id.split("/")[0]=== id_final) ){
...
//        this.alert("children: "+layer.children);
//        this.alert("dopo");
        if (typeof layer.children != 'undefined' && layer.children[0].id.split("/")[0]=== id_final ) {
           // this.alert("figli");
